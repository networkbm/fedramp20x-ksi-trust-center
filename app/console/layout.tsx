      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex items-start gap-6">
          ...
          <main className="min-w-0 flex-1 space-y-6">
            <div className="rounded-2xl border border-white/15 bg-white/[0.03] px-5 py-4 backdrop-blur-[2px]">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="rounded-full border border-white/15 bg-white/[0.03] px-3 py-1 text-xs text-white/70">Demo Data</div>
              </div>
            </div>
